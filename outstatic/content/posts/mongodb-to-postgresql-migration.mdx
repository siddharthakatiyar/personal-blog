...
&lt;StatCards&gt; &lt;StatCard label="Documents migrated" value="2M → 130M rows" sub="normalization isn't free" /&gt; &lt;StatCard label="Query time (before)" value="5 min" sub="complex aggregations" /&gt; &lt;StatCard label="Query time (after)" value="25 sec" sub="same queries, PostgreSQL" /&gt; &lt;StatCard label="Migration cost" value="USD 16.50 (INR 1,563)" sub="Gemini API credits" /&gt; &lt;/StatCards&gt;
...
&lt;ComparisonTable&gt; &lt;ComparisonHeader&gt; &lt;th&gt;Feature&lt;/th&gt; &lt;th&gt;MongoDB&lt;/th&gt; &lt;th&gt;PostgreSQL&lt;/th&gt; &lt;/ComparisonHeader&gt; &lt;ComparisonRow&gt; &lt;td&gt;Cross-collection queries&lt;/td&gt; &lt;td&gt;❌ `$lookup` pipelines, slow and verbose&lt;/td&gt; &lt;td&gt;✅ Native JOINs, fast and readable&lt;/td&gt; &lt;/ComparisonRow&gt; &lt;ComparisonRow&gt; &lt;td&gt;Transactions&lt;/td&gt; &lt;td&gt;⚠️ Exists, but bolted-on and slow&lt;/td&gt; &lt;td&gt;✅ First-class, atomic by default&lt;/td&gt; &lt;/ComparisonRow&gt; &lt;ComparisonRow&gt; &lt;td&gt;Data integrity&lt;/td&gt; &lt;td&gt;❌ Application-level only&lt;/td&gt; &lt;td&gt;✅ FK constraints, not-null, unique&lt;/td&gt; &lt;/ComparisonRow&gt; &lt;ComparisonRow&gt; &lt;td&gt;Schema flexibility&lt;/td&gt; &lt;td&gt;✅ Schema-free, great for early iteration&lt;/td&gt; &lt;td&gt;⚠️ Rigid, requires upfront design&lt;/td&gt; &lt;/ComparisonRow&gt; &lt;ComparisonRow&gt; &lt;td&gt;JSON support&lt;/td&gt; &lt;td&gt;✅ Native document model&lt;/td&gt; &lt;td&gt;✅ JSONB with GIN indexing&lt;/td&gt; &lt;/ComparisonRow&gt; &lt;ComparisonRow&gt; &lt;td&gt;Analytics / reporting&lt;/td&gt; &lt;td&gt;❌ Painful at scale&lt;/td&gt; &lt;td&gt;✅ SQL is purpose-built for this&lt;/td&gt; &lt;/ComparisonRow&gt; &lt;ComparisonRow&gt; &lt;td&gt;Simple CRUD verbosity&lt;/td&gt; &lt;td&gt;✅ Minimal boilerplate with ORMs&lt;/td&gt; &lt;td&gt;⚠️ More verbose with raw queries&lt;/td&gt; &lt;/ComparisonRow&gt; &lt;/ComparisonTable&gt;
...
&lt;Callout type="warning"&gt; This section exists because most migration posts only tell you about the wins. These are real costs — not dealbreakers, but worth knowing before you commit. &lt;/Callout&gt;
...
&lt;Callout type="info"&gt; This is the section I debated including. I'm including it because I think it's the most important thing I can say about the future of backend engineering. &lt;/Callout&gt;
